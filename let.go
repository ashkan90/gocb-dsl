...
type LetClause interface {
	...
	RightJoin(from interface{}) JoinClause

	RightOuterJoin(from interface{}) JoinClause
...
func (c *defaultLetClause) Join(from interface{}) JoinClause {
	log.Println("join: ", toString(from))
...
func (c *defaultLetClause) RightJoin(from interface{}) JoinClause {
	c.setElement(&joinElement{right, toString(from)})
	return newDefaultJoinClause(c)
}

func (c *defaultLetClause) RightOuterJoin(from interface{}) JoinClause {
	c.setElement(&joinElement{rightOuter, toString(from)})
	return newDefaultJoinClause(c)
}
