...
// Any asd
func Any(what string) *Expression {
	return prefix("ANY", what)
}
...
func (e *Expression) Satisfies(satisfaction string) *Expression {
	return infix("SATISFIES", e.String(), satisfaction)
}

func (e *Expression) End() *Expression {
	return postfix("END", e.String())
}
...
func toString(value interface{}) string {
	...
	default:
		...
		switch value.(type) {
		case Statement:
			return fmt.Sprintf("(%s)", value.(Statement).String())
		}
